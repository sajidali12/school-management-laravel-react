                                        ...
                                        <div className="flex justify-end gap-1">
                                            {s.user ? (
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        if (confirm(`Remove login account for ${s.full_name}?`)) {
                                                            router.delete(`/students/${s.id}/account`);
                                                        }
                                                    }}
                                                >
                                                ...
                                                <Button
                                                    ...
                                                    title={s.email ? 'Create login account' : 'Add email to student first'}
                                                    disabled={!s.email}
                                                    onClick={() => router.post(`/students/${s.id}/account`)}
                                                >
