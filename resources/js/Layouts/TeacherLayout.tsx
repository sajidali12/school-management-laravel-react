...
const navItems: NavItem[] = [
    { label: 'Dashboard',          href: '/teacher/dashboard',          icon: <LayoutDashboard className="h-4 w-4" />, match: 'teacher/dashboard' },
    { label: 'My Attendance',      href: '/teacher/attendance',         icon: <UserCheck className="h-4 w-4" />,       match: 'teacher/attendance' },
    { label: 'Student Attendance', href: '/teacher/student-attendance', icon: <Users className="h-4 w-4" />,           match: 'teacher/student-attendance' },
    { label: 'Lesson Plans',       href: '/teacher/lesson-plans',       icon: <BookOpen className="h-4 w-4" />,        match: 'teacher/lesson-plans' },
    { label: 'Assignments',        href: '/teacher/assignments',        icon: <ClipboardList className="h-4 w-4" />,   match: 'teacher/assignments' },
];
...
export default function TeacherLayout({ title, description, actions, children }: PropsWithChildren<TeacherLayoutProps>) {
            ...
            <aside className={cn(
                ...
                <div className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="truncate text-xs text-muted-foreground">Teacher Portal</div>
                    </div>
